...
import static com.github.kondury.quiz.config.MessageConfig.QUIZ_DIDNT_PASS_TMPL_CODE;
import static com.github.kondury.quiz.config.MessageConfig.QUIZ_PASSED_TMPL_CODE;
...
public class EvaluationServiceImpl implements EvaluationService {
    ...
    public QuizResult getResults(Student student) {
        ...
        String messageCode = hasPassed(grade) ? QUIZ_PASSED_TMPL_CODE : QUIZ_DIDNT_PASS_TMPL_CODE;
    ...
    private boolean hasPassed(int finalGrade) {
        return finalGrade >= properties.getEvaluationMinPercentageToPass();
    }
