...
class CsvQuizDaoTest {
    ...
    private CsvDaoSettingsProvider csvDaoSettingsProvider;
    ...
    void setUp() {
        ...
        csvDaoSettingsProvider = mock(CsvDaoSettingsProvider.class);

        csvQuizDao = new CsvQuizDao(csvDaoSettingsProvider, questionFactory, fileReader);
    }
    ...
    void getQuestions_shouldReturnResultListFromFileReaderBeingCalledWithExpectedArguments() {
        ...
        given(csvDaoSettingsProvider.getCsvFilename()).willReturn(csvFilename);
